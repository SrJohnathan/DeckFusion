...
public class ScaleToAction extends TemporalAction {
        ...
        protected void begin () {
                startX = getActor3d().getScaleX();
                startY = getActor3d().getScaleY();
                startZ = getActor3d().getScaleZ();
        }

        @Override
        protected void update (float percent) {
                getActor3d().setScale(startX + (endX - startX) * percent, startY + (endY - startY) * percent,
